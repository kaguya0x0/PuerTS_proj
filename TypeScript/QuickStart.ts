...
//let world1 = (argv.getByName("GameInstance") as UE.GameInstance).GetWorld() as UE.World;
//调试器通过websocket发送断点信息，可能断点生效前脚本已经执行完备，可以通过debugger语句来主动触发断点
//debugger;
//let widgetClass1 = UE.Class.Load("/Game/StarterContent/TestWidgetBlueprint.TestWidgetBlueprint_C");
//let widget1 = UE.UMGManager.CreateWidget(world1, widgetClass1) as UE.Game.StarterContent.TestWidgetBlueprint.TestWidgetBlueprint_C;
//widget1.AddToViewport(0);
//widget1.Button1.OnClicked.Add(() => {
    //console.log("button clicked!");
    //console.log("inputed text:" + widget1.TextBox.GetText());
//});
